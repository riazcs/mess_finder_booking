...
<div id="post">
    <div class="container">
        <div class="row mt-5">
            ...
            <div class="col-lg-7 col-xl-7 col-xxl-7 col-md-7 col-sm-11 col-11 user-post-main" id="user-post-main-one">
                <div class="user-post-child">
                    <div class="user-info">
                        @if($item->user) <img src="{{Voyager::image($item->user->avatar)}}" class="img-fluid" alt="">
                        @endif
                        <p class="user-name">{{ $item->title }}</p>
                        <p class="user-name">{{ $item->user ? $item->user->name : " " }}</p>
                        <p class="post-time">{{ $item->created_at->format('M d, Y') }}</p>
                    </div>

                    <p class="create-post">{{  strip_tags($item->body) }}</p>
                    <img src="{{ Voyager::image($item->image) }}" class="img-fluid" class="create-post-img">
...
{{-- <section class="customer"  data-aos-duration="2000">
    <div class="container">
        <h2>Our Services</h2>
